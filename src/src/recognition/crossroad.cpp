...
public:
     ...
     */
    bool crossRecognition(Tracking &track)//, vector<PredictResult> predict)
    {
            ...
            for (int i = 2; i < track.widthBlock.size() - 10; i++)
            {
                ...
                if (counterRec)
                {
                    ...
                    if (counterRec > 5)
                    {
                        ...
                        //std::cout<<"CrossroadLeft"<<std::endl;
                        break;
                    }
                }
            }
        ...
        if (crossroadType == CrossroadType::CrossroadLeft)
        {
            ...
            if(rowBreakRightDown)
                pointBreakRD = track.pointsEdgeRight[rowBreakRightDown];
        ...
        if (track.stdevLeft > 50)
        {
            ...
            {
                // 右入十字判断
                if (track.pointsEdgeRight[i].y > COLSIMAGE - 8 && track.widthBlock[i].y > track.widthBlock[i - 1].y)
                    counterRec++;
                if (counterRec)
                {
                    counterLinear++;
                    ...
                    if (counterRec > 10)
                    {
                        ...
                        std::cout<<"CrossroadRight"<<std::endl;
                        break;
                    }
                }
            }
        ...
        */
        if (track.stdevLeft > 50)
        {
            //std::cout<<"[INFO] CROSSROAD RIGHT"<<std::endl;
            // 通过色块突变-搜索十字类型
            for (int i = 2; i < track.widthBlock.size() - 10; i++)
            {
                // 右入十字判断
                if (track.pointsEdgeRight[i].y > COLSIMAGE - 8 && track.widthBlock[i].y > track.widthBlock[i - 2].y)
                    counterRec++;
                if (counterRec)
                {
                    counterLinear++;
            ...
            //std::cout<<"Crossroad Type: "<<crossroadType<<std::endl;
        }
